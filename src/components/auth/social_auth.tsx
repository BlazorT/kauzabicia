...
import { SIGN_UP_FORM, User } from "@/utils/types";
...
const SocialAuth = () => {
  ...
  const { mutate: singUp, isPending } = useSignUp();
  ...
  //     const google_user = data.user;
  //     const signUpBody = {
  //       id: 0,
  //       userId: "",
  //       avatar: google_user?.image ?? "",
  //       userName: "",
  ...
  //       genderId: 1,
  //       fmctoken: "",
  //       roleId: USER_ROLE.USER, //public user role
  //       status: 1,
  //       storeId: 1,
  ...
  //       isVerified: 1,
  //     };
  //     handleUser(signUpBody);
  //   }
  // }, [data, handleUser, status]);
